...
%AREA_DABG_RECT Effective admissible area for a rectangular aperture (3D orientation).
%
%   A = AREA_DABG_RECT(rect, a3, b3, c3, alpha, beta, gamma) computes the
%   admissible area D_theta associated with the passage of an ellipsoidal
%   particle through a rectangular opening.
%
...
%       3) evaluates the admissible area via AREA_DTHETA_RECT.
%
%   The resulting area represents the centroid domain governing particle
%   passage within the geometric–probabilistic framework developed in the
